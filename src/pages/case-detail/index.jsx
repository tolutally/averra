...
const CaseDetail = () => {
  ...
  const loadCaseData = () => {
    ...
    // If no case found, use mock data
    const mockCase = {
      id: caseId,
      name: 'Acme Corp - Standard Fintech KYB - 20240822',
      clientName: 'Acme Corporation',
      description: 'Standard Fintech KYB verification for new business account',
      status: 'pending-review',
      priority: 'high',
      deadline: '2024-08-30',
      coordinatorId: 'coord-1',
      templateId: 'template-fintech-kyb',
      ...
      setCaseData(prev => ({
        ...
        auditTrail: [
          ...prev.auditTrail,
          {
            ...
            description: `${selectedStep.title} ${action === 'approve' ? 'approved' : 'requires changes'}: ${data.notes || 'No notes provided'}`,
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                {isGeneratingAudit ? 'Generating...' : 'Export Audit'}
              </Button>
            </div>
          </div>
        </div>
